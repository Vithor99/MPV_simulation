...
T(1) = (params(42)/params(43))^params(7);
T(2) = params(39)^(-params(6));
T(3) = params(38)*y(40)+T(2)*(y(41)*params(6)-y(56));
T(4) = params(24)*(params(4)*params(43)*(1-params(16))*params(1)-params(18)*params(42)*(params(46)+params(16)*(1-params(46))*params(21))/params(47));
T(5) = params(42)*params(24)*(1-params(16)*params(21)+params(16)*params(21)/params(46));
T(6) = params(11)/(1-params(11))*(1-params(17)*(1-params(11)))/(1+params(20)/params(5)-params(20));
